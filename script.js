...
let m_price = document.querySelectorAll('.merch-item-price')
let m_price_spisok = ['1000', '1000', '2500', '5000']

let m_desc = document.querySelectorAll('.merch-item-descr')
let m_desc_spisok = ['Тарелка с принтом Марса. Доступна в...', 'Кружка с принтом марса. Доступна в...',
'Масштабная модель одной из ракет Galaxy', 'Масштабная модель масохода (мы покупаем и...']

for (let i = 0; i < 4; i += 1) {
    m_price[i].innerHTML = m_price_spisok[i]
    m_desc[i].innerHTML = m_desc_spisok[i]
}
